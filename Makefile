...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Tue Aug 21 00:11:45 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfHeaderWidget.h ElfHunterHexWidget.h ElfHunterMainWidget.h ElfHunterSideWidget.h AboutWidget.h ElfProgHeaderWidget.h ElfSectionHeaderWidget.h .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfHeaderWidget.cpp elfhunter.cpp ElfHunterHexWidget.cpp ElfHunterMainWidget.cpp ElfHunterSideWidget.cpp AboutWidget.cpp ElfProgHeaderWidget.cpp ElfSectionHeaderWidget.cpp .tmp/ElfHunter1.0.0/ && (cd `dirname .tmp/ElfHunter1.0.0` && $(TAR) ElfHunter1.0.0.tar ElfHunter1.0.0 && $(COMPRESS) ElfHunter1.0.0.tar) && $(MOVE) `dirname .tmp/ElfHunter1.0.0`/ElfHunter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ElfHunter1.0.0
...
compiler_moc_header_make_all: moc_ElfHeaderWidget.cpp moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp moc_ElfProgHeaderWidget.cpp moc_ElfSectionHeaderWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ElfHeaderWidget.cpp moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp moc_ElfProgHeaderWidget.cpp moc_ElfSectionHeaderWidget.cpp
...
moc_ElfProgHeaderWidget.cpp: ElfProgHeaderWidget.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) ElfProgHeaderWidget.h -o moc_ElfProgHeaderWidget.cpp

moc_ElfSectionHeaderWidget.cpp: ElfSectionHeaderWidget.h
