...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Wed Sep 26 15:26:35 2012
...
SOURCES       = elfhunter.cpp \
		...
		ElfStringTable.cpp \
		ElfSymTable.cpp moc_ElfHunterHexWidget.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfAuxTypes.h ElfHunterHexWidget.h ElfHunterMainWidget.h ElfHunterSideWidget.h AboutWidget.h ElfGenericHeader.h ElfMultiHeader.h ElfELFHeaderWidget.h ElfProgHeaderWidget.h ElfSectionHeaderWidget.h ElfStringTable.h ElfSymTable.h .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents elfhunter.cpp ElfHunterHexWidget.cpp ElfHunterMainWidget.cpp ElfHunterSideWidget.cpp AboutWidget.cpp ElfGenericHeader.cpp ElfMultiHeader.cpp ElfELFHeaderWidget.cpp ElfProgHeaderWidget.cpp ElfSectionHeaderWidget.cpp ElfStringTable.cpp ElfSymTable.cpp .tmp/ElfHunter1.0.0/ && (cd `dirname .tmp/ElfHunter1.0.0` && $(TAR) ElfHunter1.0.0.tar ElfHunter1.0.0 && $(COMPRESS) ElfHunter1.0.0.tar) && $(MOVE) `dirname .tmp/ElfHunter1.0.0`/ElfHunter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ElfHunter1.0.0
...
compiler_moc_header_make_all: moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp moc_ElfGenericHeader.cpp moc_ElfMultiHeader.cpp moc_ElfELFHeaderWidget.cpp moc_ElfProgHeaderWidget.cpp moc_ElfSectionHeaderWidget.cpp moc_ElfStringTable.cpp moc_ElfSymTable.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp moc_ElfGenericHeader.cpp moc_ElfMultiHeader.cpp moc_ElfELFHeaderWidget.cpp moc_ElfProgHeaderWidget.cpp moc_ElfSectionHeaderWidget.cpp moc_ElfStringTable.cpp moc_ElfSymTable.cpp
...
moc_ElfHunterSideWidget.cpp: ElfELFHeaderWidget.h \
		ElfGenericHeader.h \
		ElfProgHeaderWidget.h \
		ElfMultiHeader.h \
		ElfSectionHeaderWidget.h \
