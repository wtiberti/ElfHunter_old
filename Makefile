...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Dec 24 15:54:42 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfAuxTypes.h SelectionInfo.h ElfHunterWindow.h ElfHunterHexWidget.h ElfHunterMainWidget.h ElfHunterSideWidget.h AboutWidget.h ElfGenericHeader.h ElfMultiHeader.h ElfELFHeaderWidget.h ElfProgHeaderWidget.h ElfSectionHeaderWidget.h ElfStringTable.h ElfSymTable.h ElfHunterRelTable.h ElfHunterExec.h .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents elfhunter.cpp ElfHunterWindow.cpp ElfHunterHexWidget.cpp ElfHunterMainWidget.cpp ElfHunterSideWidget.cpp AboutWidget.cpp ElfGenericHeader.cpp ElfMultiHeader.cpp ElfELFHeaderWidget.cpp ElfProgHeaderWidget.cpp ElfSectionHeaderWidget.cpp ElfStringTable.cpp ElfSymTable.cpp ElfHunterRelTable.cpp ElfHunterExec.cpp .tmp/ElfHunter1.0.0/ && (cd `dirname .tmp/ElfHunter1.0.0` && $(TAR) ElfHunter1.0.0.tar ElfHunter1.0.0 && $(COMPRESS) ElfHunter1.0.0.tar) && $(MOVE) `dirname .tmp/ElfHunter1.0.0`/ElfHunter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ElfHunter1.0.0
...
ElfHunterExec.o: ElfHunterExec.cpp 
