...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fri Apr 19 23:14:15 2013
...
INCPATH       = -I/usr/lib64/qt/mkspecs/linux-g++-64 -I. -I/usr/lib64/qt/include/QtCore -I/usr/lib64/qt/include/QtGui -I/usr/lib64/qt/include/QtXml -I/usr/lib64/qt/include -I. -I/usr/include/okteta1 -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1 -Wl,-rpath,/usr/lib64/qt/lib
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt/lib -lokteta1core -lokteta1gui -lQtXml -L/usr/lib64/qt/lib -lQtGui -L/usr/X11R6/lib64 -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = elfhunter.cpp \
		...
		ElfHunterExec.cpp \
		ElfHunterDyn.cpp moc_ElfHunterWindow.cpp \
		...
		moc_ElfSymTable.cpp \
		moc_ElfHunterRelTable.cpp \
		moc_ElfHunterExec.cpp \
		moc_ElfHunterDyn.cpp \
		qrc_ElfHunter.cpp
OBJECTS       = elfhunter.o \
		ElfHunterWindow.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfAuxTypes.h SelectionInfo.h ElfHunterWindow.h ElfHunterHexWidget.h ElfHunterMainWidget.h ElfHunterSideWidget.h AboutWidget.h ElfGenericHeader.h ElfMultiHeader.h ElfELFHeaderWidget.h ElfProgHeaderWidget.h ElfSectionHeaderWidget.h ElfStringTable.h ElfSymTable.h ElfHunterRelTable.h ElfHunterExec.h ElfHunterConfStruct.h ElfHunterDyn.h .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfHunter.qrc .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents elfhunter.cpp ElfHunterWindow.cpp ElfHunterHexWidget.cpp ElfHunterMainWidget.cpp ElfHunterSideWidget.cpp AboutWidget.cpp ElfGenericHeader.cpp ElfMultiHeader.cpp ElfELFHeaderWidget.cpp ElfProgHeaderWidget.cpp ElfSectionHeaderWidget.cpp ElfStringTable.cpp ElfSymTable.cpp ElfHunterRelTable.cpp ElfHunterExec.cpp ElfHunterDyn.cpp .tmp/ElfHunter1.0.0/ && (cd `dirname .tmp/ElfHunter1.0.0` && $(TAR) ElfHunter1.0.0.tar ElfHunter1.0.0 && $(COMPRESS) ElfHunter1.0.0.tar) && $(MOVE) `dirname .tmp/ElfHunter1.0.0`/ElfHunter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ElfHunter1.0.0
...
moc_ElfGenericHeader.cpp: SelectionInfo.h \
		ElfGenericHeader.h
...
moc_ElfHunterRelTable.cpp: ElfMultiHeader.h \
		ElfGenericHeader.h \
		SelectionInfo.h \
		ElfAuxTypes.h \
		ElfHunterRelTable.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) ElfHunterRelTable.h -o moc_ElfHunterRelTable.cpp

moc_ElfHunterExec.cpp: ElfHunterExec.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) ElfHunterExec.h -o moc_ElfHunterExec.cpp

moc_ElfHunterDyn.cpp: ElfMultiHeader.h \
		ElfGenericHeader.h \
		SelectionInfo.h \
		ElfAuxTypes.h \
		ElfHunterDyn.h
	/usr/lib64/qt/bin/moc $(DEFINES) $(INCPATH) ElfHunterDyn.h -o moc_ElfHunterDyn.cpp

compiler_rcc_make_all: qrc_ElfHunter.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_ElfHunter.cpp
qrc_ElfHunter.cpp: ElfHunter.qrc \
		banner.png \
		icons/help-about.png \
		icons/document-open.png \
		icons/application-exit.png \
		icons/view-expenses-categories.png \
		icons/document-close.png \
		icons/view-list-tree.png \
		icons/arrow-right-double.png \
		icons/view-refresh.png
	/usr/lib64/qt/bin/rcc -name ElfHunter ElfHunter.qrc -o qrc_ElfHunter.cpp
...
ElfHunterRelTable.o: ElfHunterRelTable.cpp ElfSectionHeaderWidget.h \
		ElfMultiHeader.h \
		ElfGenericHeader.h \
		SelectionInfo.h \
		ElfHunterRelTable.h \
		ElfAuxTypes.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ElfHunterRelTable.o ElfHunterRelTable.cpp

ElfHunterExec.o: ElfHunterExec.cpp ElfHunterExec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ElfHunterExec.o ElfHunterExec.cpp

ElfHunterDyn.o: ElfHunterDyn.cpp ElfSectionHeaderWidget.h \
		ElfMultiHeader.h \
		ElfGenericHeader.h \
		SelectionInfo.h \
		ElfHunterDyn.h \
		ElfAuxTypes.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ElfHunterDyn.o ElfHunterDyn.cpp
...
moc_ElfHunterRelTable.o: moc_ElfHunterRelTable.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ElfHunterRelTable.o moc_ElfHunterRelTable.cpp

moc_ElfHunterExec.o: moc_ElfHunterExec.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ElfHunterExec.o moc_ElfHunterExec.cpp

moc_ElfHunterDyn.o: moc_ElfHunterDyn.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ElfHunterDyn.o moc_ElfHunterDyn.cpp

qrc_ElfHunter.o: qrc_ElfHunter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_ElfHunter.o qrc_ElfHunter.cpp
