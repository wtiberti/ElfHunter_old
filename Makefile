...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Mon Aug 13 21:33:18 2012
...
SOURCES       = ElfHeaderWidget.cpp \
		...
		AboutWidget.cpp moc_ElfHeaderWidget.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfHeaderWidget.h ElfHunterHexWidget.h ElfHunterMainWidget.h ElfHunterSideWidget.h AboutWidget.h .tmp/ElfHunter1.0.0/ && $(COPY_FILE) --parents ElfHeaderWidget.cpp elfhunter.cpp ElfHunterHexWidget.cpp ElfHunterMainWidget.cpp ElfHunterSideWidget.cpp AboutWidget.cpp .tmp/ElfHunter1.0.0/ && (cd `dirname .tmp/ElfHunter1.0.0` && $(TAR) ElfHunter1.0.0.tar ElfHunter1.0.0 && $(COMPRESS) ElfHunter1.0.0.tar) && $(MOVE) `dirname .tmp/ElfHunter1.0.0`/ElfHunter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ElfHunter1.0.0
...
compiler_moc_header_make_all: moc_ElfHeaderWidget.cpp moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ElfHeaderWidget.cpp moc_ElfHunterHexWidget.cpp moc_ElfHunterMainWidget.cpp moc_ElfHunterSideWidget.cpp
